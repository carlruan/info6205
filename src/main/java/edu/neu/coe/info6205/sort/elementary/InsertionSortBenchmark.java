...
public class InsertionSortBenchmark {
    ...
    public static void random(Integer[] arr){
        ...
        Benchmark_Timer benchmark_timer = new Benchmark_Timer("random test:", null , (t)->InsertionSort.sort(arr), null );
    ...
    public static void ordered(Integer[] arr){
        ...
        Benchmark_Timer benchmark_timer = new Benchmark_Timer("orderd test:", null, (t)->InsertionSort.sort(arr), null );
        System.out.println(benchmark_timer.run(true , 100));
    ...
    public static void partiallyOrdered(Integer[] arr){
        ...
        Benchmark_Timer benchmark_timer = new Benchmark_Timer("partially orderd test:", null, (t)->InsertionSort.sort(arr), null );
        System.out.println(benchmark_timer.run(true , 100));
